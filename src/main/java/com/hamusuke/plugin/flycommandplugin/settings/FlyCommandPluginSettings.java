...
public class FlyCommandPluginSettings {
	public static final BiConsumer<GeneralSetting<Boolean>, ArgumentBuilder<CommandListenerWrapper, ?>> BOOL = (setting, argumentBuilder) -> {
		argumentBuilder.then(net.minecraft.server.v1_16_R3.CommandDispatcher.a(setting.getType().getPrefix()).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a(setting.getDisplayName()).executes((execute) -> {
			sendMessage(execute.getSource(), "command.flycommandpluginsetting.get.normal", setting, false, setting.get());
			return 1;
		}).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("value", BoolArgumentType.bool()).executes((execute) -> {
	...
	public static final BiConsumer<PlayerSetting<Boolean>, ArgumentBuilder<CommandListenerWrapper, ?>> BOOL_PLAYER = (setting, argumentBuilder) -> {
		argumentBuilder.then(net.minecraft.server.v1_16_R3.CommandDispatcher.a(AbstractFlyCommandPluginSetting.Type.PLAYER.getPrefix()).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a(setting.getDisplayName()).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("targets", ArgumentEntity.d()).executes((e) -> {
			...
			return players.size();
		}).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("boolean", BoolArgumentType.bool()).executes((e) -> {
			Collection<EntityPlayer> players = ArgumentEntity.f(e, "targets");
		...
		argumentBuilder.then(net.minecraft.server.v1_16_R3.CommandDispatcher.a(AbstractFlyCommandPluginSetting.Type.OFFLINE_PLAYER.getPrefix()).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a(setting.getDisplayName()).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("target", StringArgumentType.word()).suggests(Util.suggestionProvider).executes((e) -> {
	...
	private static void sendMessage(CommandListenerWrapper commandListenerWrapper, String translationKey, @Nullable IChatBaseComponent targetOrNull, AbstractFlyCommandPluginSetting<?> setting, boolean sendToAdmin, Object... objects) {
		Object[] settingSummary = new Object[]{LanguageManager.getTranslatedText(commandListenerWrapper, "plugin.str"), new ChatComponentText(setting.getDisplayName()).format(mod -> {
			return mod.setChatClickable(new ChatClickable(ChatClickable.EnumClickAction.SUGGEST_COMMAND, setting.getCommand())).setChatHoverable(new ChatHoverable(ChatHoverable.EnumHoverAction.SHOW_TEXT, new ChatComponentText(LanguageManager.getTranslatedText(commandListenerWrapper, setting.getDescription()))));
		})};
	...
	public static class PlayerSettings {
		...
		public static final PlayerSetting<Vector> KNOCKBACK_VECTOR = new PlayerSetting<>("KnockbackVector", new Vector(0.6D, 0.5D, 0.6D), (general, argumentBuilder) -> {
			argumentBuilder.then(net.minecraft.server.v1_16_R3.CommandDispatcher.a(general.getType().getPrefix()).then(CommandDispatcher.a(general.getDisplayName()).executes((e) -> {
				...
				return 1;
			}).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("vector_x", DoubleArgumentType.doubleArg()).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("vector_y", DoubleArgumentType.doubleArg()).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("vector_z", DoubleArgumentType.doubleArg()).executes((e) -> {
		...
		public static final PlayerSetting<String> JOIN_MESSAGE = new PlayerSetting<>("JoinMessage", "multiplayer.player.joined", (general, argumentBuilder) -> {
			argumentBuilder.then(net.minecraft.server.v1_16_R3.CommandDispatcher.a(general.getType().getPrefix()).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a(general.getDisplayName()).executes((e) -> {
				...
				return 1;
			}).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("null").executes((e) -> {
				general.set("null");
				sendMessage(e.getSource(), "command.flycommandpluginsetting.set.emp", general, true);
				return 1;
			})).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("byText").then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("text", StringArgumentType.greedyString()).executes((e) -> {
				...
				return 1;
			}))).then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("byJson").then(net.minecraft.server.v1_16_R3.CommandDispatcher.a("JsonElement", ArgumentChatComponent.a()).executes((e) -> {
